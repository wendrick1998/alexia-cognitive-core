 ...
 * @description Correção de scroll e overflow para mobile, especialmente iOS
 */
  ...
  return (
    <SidebarProvider defaultOpen={!isMobile}>
      <div className="min-h-screen flex w-full transition-colors duration-300" style={{ background: '#000000' }}>
        ...
        {/* Main Content - CORRIGIDO: Implementado padrão de layout para scroll correto em iOS */}
        <main className={`flex-1 flex flex-col h-screen ${!isMobile ? 'ml-20' : ''}`}>
          ...
          {/* Content Area - CORRIGIDO: Implementado padrão absoluto/relativo para scroll correto */}

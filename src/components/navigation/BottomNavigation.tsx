...
const BottomNavigation = ({ currentSection, onSectionChange, onMenuToggle }: BottomNavigationProps) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-t border-gray-200/50 dark:border-gray-700/50 safe-area-bottom">
      <div 
        className="px-2 py-2"
              ...
              return (
                <Button
                  ...
                  className={cn(
                    ...
                    "touch-manipulation select-none min-w-[60px] relative",
                    isActive 
                      ? "bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 scale-105 shadow-sm" 

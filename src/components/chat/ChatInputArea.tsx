...
const ChatInputArea = ({ 
  ...
  return (
    <div className="flex-shrink-0 sticky bottom-0 z-10 bg-white/95 dark:bg-gray-950/95 backdrop-blur-xl border-t border-gray-200/50 dark:border-gray-700/50 shadow-lg">

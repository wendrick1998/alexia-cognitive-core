  ...
  return (
    <div className={cn("h-full flex bg-transparent", className)}>
      ...
      {!isMobile && !sidebarCollapsed && (
        <div className="w-80 border-r border-gray-200/50 dark:border-gray-700/50 flex-shrink-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl z-sidebar flex flex-col">
          {/* Header */}
          ...
          {/* Conversations List with proper scroll */}
      ...
      {isMobile && !sidebarCollapsed && (
        <>
          ...
          {/* Sidebar Panel */}
          <div className="fixed top-0 left-0 w-80 h-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-r border-gray-200/50 dark:border-gray-700/50 z-sidebar flex flex-col">
            {/* Header */}
            <div className="p-4 border-b border-gray-200/50 dark:border-gray-700/50 flex-shrink-0">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
